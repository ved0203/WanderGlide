...
.hero {
  ...
  color: var(--colour-heading);
        ...
        .hero-content { position:relative; z-index:2; max-width:800px; padding:0 1.5rem; text-align:center; } /* 👈 center aligned */
        ...
        /* Interactive */
        .interactive { padding:6rem 0; background:#fbf8f4; text-align:center; } 
        .interactive h2 { font-size:2rem; margin-bottom:2rem; }
        .rotate-container { display:flex; flex-direction:column; align-items:center; gap:1rem; } /* 👈 center */
        ...
        .product-card { background:#fff; border-radius:1rem; overflow:hidden; box-shadow:0 10px 20px rgba(0,0,0,0.05); display:flex; flex-direction:column; text-align:center; } /* 👈 center */
        ...
        .detail-item { background:#fff; padding:2rem; border-radius:1rem; box-shadow:0 10px 20px rgba(0,0,0,0.05); text-align:left; } /* 👈 left aligned */
        ...
        .footer-container { display:flex; flex-wrap:wrap; gap:2rem; justify-content:space-between; text-align: left; }
      ...
      <section id="interactive" className="interactive">
        <div className="container">
          ...
          <div className="rotate-container">
            <img src={rotateImages[rotateIndex]} alt="Interactive hoodie view" />
      ...
      <section id="story" className="story">
        <div className="container story-container">
          <div className="story-text">
            ...
            <p>
              Each WanderGlide garment is designed for those who seek freedom in travel and sophistication in style...
            </p>
        ...
        <div className="container footer-container">
          <div className="footer-brand">
            ...
            <div className="footer-contact">
              <p>Email: <a href="mailto:info@aerigo.com">info@aerigo.com</a></p>
              <div className="social-icons">
                <a href="https://www.instagram.com/aerigo.co/" target="_blank" aria-label="Instagram">
                  <img src="/Wanderglide/instagram.png" alt="Instagram" />
                </a>
                <a href="https://www.pinterest.com/aerigoco/?invite_code=8496e5049cb44c20bcbc139ae1b67b80&sender=1036461439151278706" target="_blank" aria-label="Pinterest">
                  <img src="/Wanderglide/pinterest.png" alt="Pinterest" />
                </a>
              </div>
            </div>
          </div>
